#!/usr/bin/env python
# Downloads MP public data release (Python 3 port of the official download_mp.py).
# Faithful to the original Matterport3D script; only ported to Python 3 and with
# the task-data download indentation bug fixed so it downloads reliably.
# -*- coding: utf-8 -*-
import argparse
import os
import tempfile
